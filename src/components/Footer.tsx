...
// Custom social icons since lucide renames them
const FacebookIcon = () => (
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          >
            ...
            <div className="flex gap-4">
              <motion.a
                href="#"
                className="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center hover:bg-[#02537E] transition-colors"
                whileHover={{ y: -3 }}
              >
                <FacebookIcon />
              </motion.a>
